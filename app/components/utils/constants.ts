...
export const filterButtonStyles: string =
	'flex items-center justify-center !text-2xl !mt-3 !border-[3px] border-yellow !px-3 !py-[2px] transition-all duration-500 text-yellow hover:border-purple hover:text-purple dark:text-black dark:border-black !bg-transparent hover:bg-yellow dark:hover:bg-purple rounded-md';
